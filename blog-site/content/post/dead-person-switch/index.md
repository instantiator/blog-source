...
* [Dead Person Switches - with or without trust](DPS-thesis-LGW.2021-09-01.with-appendices.pdf)
...
![High level diagram representing a DPS](dps-threat-model-scoping.png "High level diagram representing a DPS")
...
![A classic microservice architecture design for a DPS](microservices.png "A classic microservice architecture design")
...
![Activation flow for a DPS composed of a smart contract and secret contract](smart-and-secret-contract-flow.png "Activation flow for a DPS composed of a smart contract and secret contract")
...
![A matrix showing 12 existing DPS solutions, and 3 proposed designs - each with their scores per requirement](matrix.png "Scores for all designs")
...
**If you'd like to know more, feel free to [give it a read](DPS-thesis-LGW.2021-09-01.with-appendices.pdf) and reach out - I'd be glad to chat about it.**
