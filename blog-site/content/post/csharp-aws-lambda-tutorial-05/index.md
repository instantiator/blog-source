...
![Create an S3 bucket](010-create-s3-bucket.png)
...
![S3 bucket permissions](011-s3-bucket-permissions.png)
...
![Bucket policy (set)](013-s3-bucket-policy-set.png)
...
![Adding the AWS SDK for S3 in Nuget](014-add-aws-sdk-s3-nuget.png)
...
![Test write to S3](015-test-write-to-s3.png)
...
![Download the file from S3](016-download-file-from-s3.png)
