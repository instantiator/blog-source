...
![the qFlipper app showing the firmware view and the big green update button](qflipper-update.png)
...
![A screenshot of visual studio code showing a terminal with ufbt create, and the application manifest it has created](ufbt-create.png)
