...
images: [ "multiplexing-slides-1-and-2.gif" ]
thumbnail: "multiplexing-slides-1-and-2.gif"
...
RevealJS has another feature: Multiplexing. This allows one (or more) client slide shows to follow the progress of one (or more) ~~master~~ controller slide show. This capability is available as the [Multiplex plugin](https://github.com/shared/reveal/multiplex). It can be easily enabled, provided you have access to its socket.io server.
...
- See: [reveal/multiplex](https://github.com/shared/reveal/multiplex)
