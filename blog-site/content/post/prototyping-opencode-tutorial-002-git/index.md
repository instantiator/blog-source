...
|-|-|-|-|-|
| <img src="./git-icon.webp" alt="The git icon. It's a diamond shape, with a line entering on the top left edge, travelling down and right. The line forks inside the diamond at a little round node. One path continues diagonally down-and-right, the other goes directly downwards. Both terminate with a small round node. It's suggestive of a path that splits, with one continuing straight, and the other being an alternative path." style="height: 10vh; width: auto; background: #ffffffdd; padding: 2vw; border-radius: 5px;" /> | <img src="./github-icon.svg" alt="The gitub icon is a round disc, containing a cutout of Octocus, their mascot. It's a cat with (supposedly) 8 tentacles, although most are bunched together in the picture, with really only 1 waving to the side, suggestive of an alternate branching path." style="height: 10vh; width: auto; background: #ffffffdd; padding: 2vw; border-radius: 5px;" /> | <img src="./gitlab-icon.svg" alt="The gitlab icon is an angular representation of a fox head. It has 2 pointy ears and a pointy nose. Looking at the points, it might be suggestive of a single node (the nose) that forks to two paths (the two ears)." style="height: 10vh; width: auto; background: #ffffffdd; padding: 2vw; border-radius: 5px;" /> | <img src="./bitbucket-icon.webp" alt="The BitBucket icon is a bucket shape drawn as hollow, with a thick outline. It has a small segment missing top right, which forces it into the shape of a 'G' - perhaps representing git." style="height: 10vh; width: auto; background: #ffffffdd; padding: 2vw; border-radius: 5px;" /> | <img src="./gitea-icon.webp" alt="The Gitea icon is a cub of tea with a teabag label draped over the side, which has a representation of a git branch on it. It's a square tag that contains a line entering from one side that forks. It splits at a small round node, and each new line terminates with a small round node. One line continues straight, the other leaves perpendicular to the first, and curves 90 degrees to become parallel with the first." style="height: 10vh; width: auto; background: #ffffffdd; padding: 2vw; border-radius: 5px;" /> |
